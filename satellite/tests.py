...
class SatelliteTestCases(TestCase):
    ...
    def test_post_true_color(self):
        ...
        response = self.client.post('/satellite/images/', {'channel': 'true_color'})
    ...
    def test_post_1_blue(self):
        ...
        response = self.client.post('/satellite/images/', {'channel': '1_blue'})
        image_cycle = response.json()['image_cycle']
    ...
    def test_post_2_red(self):
        ...
        response = self.client.post('/satellite/images/', {'channel': '2_red'})
        image_cycle = response.json()['image_cycle']
    ...
    def test_post_4_nir(self):
        ...
        response = self.client.post('/satellite/images/', {'channel': '4_nir'})
        image_cycle = response.json()['image_cycle']
    ...
    def test_post_9_wv(self):
        ...
        response = self.client.post('/satellite/images/', {'channel': '9_wv'})
        image_cycle = response.json()['image_cycle']
    ...
    def test_post_14_longwave(self):
        ...
        response = self.client.post('/satellite/images/', {'channel': '14_longwave'})
        image_cycle = response.json()['image_cycle']
