...
class RadarTestCase(TestCase):
    ...
    def test_post_ref_images(self):
        ...
        response = self.client.post('/radar/images/', {'radar_type': 'ref'})
    ...
    def test_post_vel_images(self):
        ...
        response = self.client.post('/radar/images/', {'radar_type': 'vel'})
        image_cycle = response.json()['image_cycle']
    ...
    def test_post_zdr_images(self):
        ...
        response = self.client.post('/radar/images/', {'radar_type': 'zdr'})
        image_cycle = response.json()['image_cycle']
