...
def generate_kvum(launch, ascent):
    ...
    p3km = interp.pres(prof, interp.to_msl(prof, 3000.0))
    ...
    for t in np.arange(-10, 45, 5):
        ...
        for p in presvals:
            tw.append(thermo.wetlift(1000.0, t, p))
    ...
    plt.savefig('static/soundings/launches/'+launch+'_'+ascent+'/'+launch+'_'+ascent+'_KVUM.png', dpi=150)
