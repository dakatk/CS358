...
<?php
$pagename = 'Forecasts - 0.5 Deg GFS Model Data';
$id = "forecast";
...
echo "<div><title> Valparaiso University | ' $pagename '</title></div> \r\n";
...
<div class="container">
  ...
  <div class="sidebar1">
    <ul class="nav"><center>
      ...
      <li><a href="http://bergeron.valpo.edu/ncep_models" align=center><font size=4 color=#ffcc00><b>GFS Model</b></font></a></li>
...
if ($typ == null) $typ = 500;
if ($siz == null) $siz = 81;
if ($model == null) $model = "gfs";
if ($p==null) $p = "four_panel";
if ($q==null) $q = "temp";
if($model == "wrf") {$max = 25;}
elseif($model == "gfs") {$max = 81;}
...
$crc = "http://bergeron.valpo.edu/ncep_models/gfs/gfs_${b}_f";
...
<div class=gfs>
<img style="width:950px;height:auto;" src="" name="animation">
</div>
<?php
...
#  $string = "http://www.nco.ncep.noaa.gov/pmb/nwprod/analysis/namer/$model/$ftime/images/${model}_${typ}_$fhr$siz.gif";
  ...
  if ($model == "gfs" || $model == "nam") {
    echo "temp[$i] = \"$crc";
    if ($FH > 100) { printf('%03.0f',$FH); }
    else { printf('%02.0f',$FH); }
    echo ".png\";\n";
  }
  elseif ($model == "wrf") {
       if ($b == "temp") {
