...
<div class="container">
  ...
  <div class="sidebar1">
    <ul class="nav">
      ...
      <li><a href="http://bergeron.valpo.edu/radar" align=center><font size=4>Local Radar</font></a></li>
...
<table width=1000 height=170 border=0 class="shortterm" align=center style="background-color: #c8b18b; border-radius:20px;">
  <tr>
    <td align=center valign=top>
    <font size=4><b>Valpo Forecast</b></font><br><br>
      <table width=980 border=0 cellspacing=0 cellpadding=0 class="shortterm">
        <tr align="center">
          <td align="center" width=200><b><?php echo $fcst_per1_day[0]; ?></td>
          <td align="center" width=200><b><?php echo $fcst_per2_day[0]; ?></td>
          <td align="center" width=200><b><?php echo $fcst_per3_day[0]; ?></td>
          <td align="center" width=200><b><?php echo $fcst_per4_day[0]; ?></td>
          <td align="center" width=200><b><?php echo $fcst_per5_day[0]; ?></td>
        </tr>
      </table>
      ...
      <table width=900>
        <tr>
          <td>
            <table width=190 height=120 border=0 cellspacing=0 cellpadding=0 class="shortterm">
              <tr valign="center" style="background: url('http://bergeron.valpo.edu/images/today<?php if (ltrim($fcst_per1_precip[1])=='none') {if ($time>7|$time<19) {echo ltrim($fcst_per1_cloud[1]); } else {echo ltrim($fcst_per1_cloud[1].'n');}} else {echo ltrim($fcst_per1_precip[1]);}?>.jpg') no-repeat 0 0; position: relative;"> 
                <td align="center" valign="center">
                  <FONT class="weather"><b><?php echo $fcst_per1_cloud[2]; ?></FONT><br>
                  <FONT class="weather"><b><?php echo $fcst_per1_pop[1]; if (ltrim($fcst_per1_precip[1])!='none') {echo "&#37; Chance of ";} echo $fcst_per1_precip[2]; ?></FONT>
                </td>
          ...
          <td>
            <table width=190 height=120 border=0 cellspacing=0 cellpadding=0 class="shortterm">
              <tr valign="center" style="background: url('http://bergeron.valpo.edu/images/today<?php if (ltrim($fcst_per2_precip[1])=='none') {if ($time>7|$time<19) {echo ltrim($fcst_per2_cloud[1].'n'); } else {echo ltrim($fcst_per2_cloud[1]);}} else {echo ltrim($fcst_per2_precip[1]);}?>.jpg') no-repeat 0 0; position: relative;"> 
                <td align="center"  valign="center">
                  <FONT class="weather"><b><?php echo $fcst_per2_cloud[2]; ?></FONT><br>
                  <FONT class="weather"><b><?php echo $fcst_per2_pop[1]; if (ltrim($fcst_per2_precip[1])!='none') {echo "&#37; Chance of ";} echo $fcst_per2_precip[2]; ?></FONT>
                </td>
                <td align="center" width=100>
          ...
          <td>
            <table width=190 height=120 border=0 cellspacing=0 cellpadding=0 class="shortterm">
              <tr valign="center" style="background: url('http://bergeron.valpo.edu/images/today<?php if (ltrim($fcst_per3_precip[1])=='none') {echo ltrim($fcst_per3_cloud[1]); } else {echo ltrim($fcst_per3_precip[1]);}?>.jpg') no-repeat 0 0; position: relative;"> 
                <td align="center"  valign="center">
                  <FONT class="weather"><b><?php echo $fcst_per3_cloud[2]; ?></FONT><br>
                  <FONT class="weather"><b><?php echo $fcst_per3_pop[1]; if (ltrim($fcst_per3_precip[1])!='none') {echo "&#37; Chance of ";} echo $fcst_per3_precip[2]; ?></FONT>
                </td>
                <td align="center" width=100>
                  <FONT class="subheader"><b><?php echo $fcst_per3_low[0];?>:</FONT>
                  <FONT class="variablesmall"><b><?php echo $fcst_per3_low[1];?> &deg;F </FONT><BR>
                  <FONT class="subheader"><b><?php echo $fcst_per3_high[0];?>:</FONT>
                  <FONT class="variablesmall"><b><?php echo $fcst_per3_high[1];?> &deg;F </FONT><BR><BR>
                  <FONT class="subheader"><b>Wind:</FONT><BR>
                  <FONT class="variablesmall"><b><?php echo $fcst_per3_wd[1]; ?> <?php echo $fcst_per3_ws[1]; ?> kts</FONT>
                </td>
              </tr>
            </table>
          </td>
          <td>
            <table width=190 height=120 border=0 cellspacing=0 cellpadding=0 class="shortterm">
              <tr valign="center" style="background: url('http://bergeron.valpo.edu/images/today<?php if (ltrim($fcst_per4_precip[1])=='none') {echo ltrim($fcst_per4_cloud[1]); } else {echo ltrim($fcst_per4_precip[1]);}?>.jpg') no-repeat 0 0; position: relative;"> 
                <td align="center" valign="center">
                  <FONT class="weather"><b><?php echo $fcst_per4_cloud[2]; ?></FONT><br>
                  <FONT class="weather"><b><?php echo $fcst_per4_pop[1]; if (ltrim($fcst_per4_precip[1])!='none') {echo "&#37; Chance of ";} echo $fcst_per4_precip[2]; ?></FONT>
                </td>
                <td align="center" width=100>
                  <FONT class="subheader"><b><?php echo $fcst_per4_low[0];?>:</FONT>
                  <FONT class="variablesmall"><b><?php echo $fcst_per4_low[1];?> &deg;F </FONT><BR>
                  <FONT class="subheader"><b><?php echo $fcst_per4_high[0];?>:</FONT>
                  <FONT class="variablesmall"><b><?php echo $fcst_per4_high[1];?> &deg;F </FONT><BR><BR>
                  <FONT class="subheader"><b>Wind:</FONT><BR>
                  <FONT class="variablesmall"><b><?php echo $fcst_per4_wd[1]; ?> <?php echo $fcst_per4_ws[1]; ?> kts</FONT>
                </td>
              </tr>
            </table>
          </td>
          <td>
            <table width=190 height=120 border=0 cellspacing=0 cellpadding=0 class="shortterm">
              <tr valign="center" style="background: url('http://bergeron.valpo.edu/images/today<?php if (ltrim($fcst_per5_precip[1])=='none') {echo ltrim($fcst_per5_cloud[1]); } else {echo ltrim($fcst_per5_precip[1]);}?>.jpg') no-repeat 0 0; position: relative;"> 
                <td align="center" valign="center">
                  <FONT class="weather"><b><?php echo $fcst_per5_cloud[2]; ?></FONT><br>
                  <FONT class="weather"><b><?php echo $fcst_per5_pop[1]; if (ltrim($fcst_per5_precip[1])!='none') {echo "&#37; Chance of ";} echo $fcst_per5_precip[2]; ?></FONT>
                </td>
                <td align="center" width=100>
                  <FONT class="subheader"><b><?php echo $fcst_per5_low[0];?>:</FONT>
                  <FONT class="variablesmall"><b><?php echo $fcst_per5_low[1];?> &deg;F </FONT><BR>
                  <FONT class="subheader"><b><?php echo $fcst_per5_high[0];?>:</FONT>
                  <FONT class="variablesmall"><b><?php echo $fcst_per5_high[1];?> &deg;F </FONT><BR><BR>
                  <FONT class="subheader"><b>Wind:</FONT><BR>
                  <FONT class="variablesmall"><b><?php echo $fcst_per5_wd[1]; ?> <?php echo $fcst_per5_ws[1];?> kts</FONT>
                </td>
              </tr>
            </table>
          </td>
      ...
      <table width=900 border=0 cellspacing=0 cellpadding=0 class="shortterm">
