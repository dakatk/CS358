...
<table width=1000 height=325 border=0 class="shortterm" align=center style="background-color: #c8b18b; border-radius:20px;">
  <tr>
      ...
      <table width=980 border=0 cellspacing=1 cellpadding=0 class="shortterm">
        <tr align="center">
          ...
          <td valign="top" align="center" width=200 height=200 style="background-color: #ffcc00; border-radius:20px;">
            ...
            <div class="precip"><?php echo $fcst_per1_pop[1]; if (ltrim($fcst_per1_precip[1])!='none') {echo "&#37; Chance of "; echo $fcst_per1_precip[2];} else {echo "0% Chance of Precip";} ?></div>
          ...
          <td valign="top" align="center" width=200 height=200 style="background-color: #ffcc00; border-radius:20px;">
            ...
            <div class="precip"><?php echo $fcst_per2_pop[1]; if (ltrim($fcst_per2_precip[1])!='none') {echo "&#37; Chance of "; echo $fcst_per2_precip[2];} else {echo "0% Chance of Precip";} ?></div>
          ...
          <td valign="top" align="center" width=200 height=200 style="background-color: #ffcc00; border-radius:20px;">
            ...
            <div class="precip"><?php echo $fcst_per3_pop[1]; if (ltrim($fcst_per3_precip[1])!='none') {echo "&#37; Chance of "; echo $fcst_per3_precip[2];} else {echo "0% Chance of Precip";} ?></div>
          ...
          <td valign="top" align="center" width=200 height=200 style="background-color: #ffcc00; border-radius:20px;">
            ...
            <div class="precip"><?php echo $fcst_per4_pop[1]; if (ltrim($fcst_per4_precip[1])!='none') {echo "&#37; Chance of "; echo $fcst_per4_precip[2];} else {echo "0% Chance of Precip";} ?></div>
          ...
          <td valign="top" align="center" width=200 height=200 style="background-color: #ffcc00; border-radius:20px;">
            ...
            <div class="precip"><?php echo $fcst_per5_pop[1]; if (ltrim($fcst_per5_precip[1])!='none') {echo "&#37; Chance of "; echo $fcst_per5_precip[2];} else {echo "0% Chance of Precip";} ?></div>
