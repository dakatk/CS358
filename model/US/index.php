...
$pagename = 'CONUS Forecasts - WRF Simulation Model Data';
$id = "forecast";
...
<table class="text1" border="1" align=center style="border-style:solid" bgcolor="white" cellpadding=3>
 ...
 <tr><td align=center>
  <a href="/model/US/conus/mslp/temp" class="menuA">MSLP </a></td>
 <td align=center>
  <a href="/model/US/conus/temp/850" class="menuA">850 hPa </br> Temp</a>
 </td></tr>
<tr> <td align=center>
  <a href="/model/US/conus/mslp/dewp" class="menuA">Sfc </br> Dewp</a>
 </td>
 <td align=center>
  <a href="/model/US/conus/temp/700" class="menuA">700 hPa </br> Temp</a>
 </td></tr>
<tr><td align=center>
  <a href="/model/US/conus/precip/total" class="menuA">Precip</br></a>
 </td>
 <td align=center>
  <a href="/model/US/conus/temp/500" class="menuA">500 hPa </br> Temp</a>
 </td></tr>
 <tr><td align=center>
  <a href="/model/US/conus/wind/850" class="menuA">850 hPa </br> Winds</a>
 </td>
 <td align=center>
  <a href="/model/US/conus/wind/300" class="menuA">300 hPa </br> Winds</a>
 </td></tr>
 <tr><td align=center>
  <a href="/model/US/conus/wind/700" class="menuA">700 hPa </br> Winds</a>
 </td>
 <td align=center>
  <a href="/model/US/conus/vort/700" class="menuA">700 hPa </br> Vort</a>
 </td></tr>
 <tr><td align=center>
  <a href="/model/US/conus/wind/500" class="menuA">500 hPa </br> Winds</a>
 </td>
 <td align=center>
  <a href="/model/US/conus/vort/500" class="menuA">500 hPa </br> Vort</a>
 </td></tr>
</table>
<br>
<br>
...
if ($typ == null) $typ = 500;
if ($siz == null) $siz = m;
if ($model == null) $model = conus;
if ($p==null) $p = "mslp";
if ($q==null) $q = "temp";
if($model == "conus") {$max = 25;}
...
$crc = "http://bergeron.valpo.edu/model/conus/d01_${b}_${c}_f";
...
#  else $fhr = $fhr;
  ...
  elseif ($model == "conus") {
       if ($b == "temp") {
        $crc = "http://bergeron.valpo.edu/model/conus/d01_${c}mb_${b}_f";
        echo "temp[$i] = \"$crc";
        #echo "temp[$i] = \"/model/conus/${q}_${p}_${i}";
          printf('%02.0f',$FH);
          echo ".png\";\n";
       }
       elseif ($b == "wind") {
...
#        echo "temp[$i] = \"/model/conus/${q}_${p}_${i}";
        #$crc = "http://bergeron.valpo.edu/model/conus/${b}_";
        echo "temp[$i] = \"$crc";
        printf('%02.0f',$FH);
        echo ".png\";\n";
       }
...
#        echo "temp[$i] = \"/model/conus/${q}_${p}_${i}";
        #$crc = "http://bergeron.valpo.edu/model/conus/${b}_";
        $crc = "http://bergeron.valpo.edu/model/conus/d01_${c}_f";
        echo "temp[$i] = \"$crc";
        printf('%02.0f',$FH);
        echo ".png\";\n";
       }
...
#       echo "temp[$i]= \"/~jyoung/images/models/ruc_${p}_${typ}_"; 
#        echo "temp[$i] = \"/model/conus/${q}_${p}_${i}";
        $crc = "http://bergeron.valpo.edu/model/conus/d01_${b}_f";
        echo "temp[$i] = \"$crc";
        printf('%02.0f',$FH);
        echo ".png\";\n";
       }
