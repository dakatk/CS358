...
$pagename = 'HiRES Forecasts - WRF Simulation Model Data';
$id = "forecast";
...
<table class="text1" border="1" align=center style="border-style:solid" bgcolor="white" cellpadding=3>
 ...
 <tr><td align=center>
  <a href="/model/HiRES/4km/mslp/temp" class="menuA">MSLP </a></td>
 <td align=center>
  <a href="/model/HiRES/4km/temp/850" class="menuA">850 hPa </br> Temp</a>
 </td></tr>
<tr> <td align=center>
  <a href="/model/HiRES/4km/mslp/dewp" class="menuA">Sfc </br> Dewp</a>
 </td>
 <td align=center>
  <a href="/model/HiRES/4km/temp/700" class="menuA">700 hPa </br> Temp</a>
 </td></tr>
<tr><td align=center>
  <a href="/model/HiRES/4km/precip/total" class="menuA">Precip</br></a>
 </td>
 <td align=center>
  <a href="/model/HiRES/4km/temp/500" class="menuA">500 hPa </br> Temp</a>
 </td></tr>
 <tr><td align=center>
  <a href="/model/HiRES/4km/wind/850" class="menuA">850 hPa </br> Winds</a>
 </td>
 <td align=center>
  <a href="/model/HiRES/4km/wind/300" class="menuA">300 hPa </br> Winds</a>
 </td></tr>
 <tr><td align=center>
  <a href="/model/HiRES/4km/wind/700" class="menuA">700 hPa </br> Winds</a>
 </td>
 <td align=center>
  <a href="/model/HiRES/4km/vort/700" class="menuA">700 hPa </br> Vort</a>
 </td></tr>
 <tr><td align=center>
  <a href="/model/HiRES/4km/wind/500" class="menuA">500 hPa </br> Winds</a>
 </td>
 <td align=center>
  <a href="/model/HiRES/4km/vort/500" class="menuA">500 hPa </br> Vort</a>
 </td></tr>
 <tr><td align=center>
  <a href="/model/HiRES/4km/dbz/ref" class="menuA">Sim. Radar </br> Ref</a>
 </td>
 <td align=center>
...
<br>
<table>
<td align=center width=150 bgcolor="#00FF00"><a href="http://bergeron.valpo.edu/model"> Valpo <br> Domain</a></td>
...
$crc = "http://bergeron.valpo.edu/model/4km/d01_${b}_${c}_f";
...
#  else $fhr = $fhr;
  ...
  elseif ($model == "4km") {
       if ($b == "temp") {
        $crc = "http://bergeron.valpo.edu/model/4km/d01_${c}mb_${b}_f";
        echo "temp[$i] = \"$crc";
        #echo "temp[$i] = \"/model/4km/${q}_${p}_${i}";
          printf('%02.0f',$FH);
          echo ".png\";\n";
       }
       elseif ($b == "wind") {
...
#        echo "temp[$i] = \"/model/4km/${q}_${p}_${i}";
        #$crc = "http://bergeron.valpo.edu/model/4km/${b}_";
        echo "temp[$i] = \"$crc";
        printf('%02.0f',$FH);
        echo ".png\";\n";
       }
...
#        echo "temp[$i] = \"/model/4km/${q}_${p}_${i}";
        #$crc = "http://bergeron.valpo.edu/model/4km/${b}_";
        $crc = "http://bergeron.valpo.edu/model/4km/d01_${c}_f";
        echo "temp[$i] = \"$crc";
        printf('%02.0f',$FH);
        echo ".png\";\n";
       }
...
#       echo "temp[$i]= \"/~jyoung/images/models/ruc_${p}_${typ}_"; 
#        echo "temp[$i] = \"/model/4km/${q}_${p}_${i}";
        $crc = "http://bergeron.valpo.edu/model/4km/d01_${b}_f";
        echo "temp[$i] = \"$crc";
        printf('%02.0f',$FH);
        echo ".png\";\n";
       }
